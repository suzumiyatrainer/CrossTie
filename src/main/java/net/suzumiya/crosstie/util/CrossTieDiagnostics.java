 ...
 *
 * <p>各カウンタは全てアトミックであり、マルチスレッドから安全にインクリメントできる。
...
public final class CrossTieDiagnostics {
    ...
    public static void logAndReset() {
        ...
        CrossTie.LOGGER.info(
                "[CrossTie Diagnostics] nashorn_render={} dl_compile={} ngt_draw={}"
                        + " setBlock={} markBlock={} notifyBlock={} skipped_setBlock={}"
                        + " refCache_hit={} refCache_miss={}",
                nashorn, dlCompile, ngtDraw,
                setBlock, markBlock, notifyBlock, skipped,
                cacheHit, cacheMiss);
    }
}